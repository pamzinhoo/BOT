...
export function MonetizationPage() {
  ...
  return (
    <>
      <PageHeader title="Monetização" description="Fase 3.1 somente leitura + Fase 3.2: analytics e gerenciamento seguro de planos; não exibe QR Code PIX e não altera pagamentos, assinaturas ou licenças." />
